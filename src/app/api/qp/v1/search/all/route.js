...
const searchConfigs = [
    { model: QPUniversities, name: "university", fields: ["name", "city", "state", "district"] },
    { model: QPColleges, name: "college", fields: ["name", "location"] },
    { model: QPCourse, name: "course", fields: ["name"] },
    { model: QPSubjects, name: "subject", fields: ["name"] }
];
