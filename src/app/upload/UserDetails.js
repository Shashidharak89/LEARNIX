...
export default function UserDetails() {
  const [usn, setUsn] = useState("NU25MCA117");
  ...
  return (
    <div style={{ padding: "20px", maxWidth: "900px", margin: "auto" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        />
        <button onClick={() => fetchUserDetails(usn)}>Search</button>
      </div>
        ...
        <div>
          ...
          {user.subjects.length === 0 ? (
            ...
            user.subjects.map((sub, sIdx) => (
              <div key={sIdx} style={{ marginBottom: "20px", border: "1px solid #ccc", padding: "10px" }}>
